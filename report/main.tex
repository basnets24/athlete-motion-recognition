...
Random Forest, having achieved the highest 5-fold CV accuracy (0.3039), was selected as the best model and used for all subsequent analyses: the window size sweep, confusion matrices, per-class metrics, and error analysis.
...
\midrule
\rowcolor{LightBlue} SVM-RBF       & 0.310 & 0.311 & 0.315 & 0.313 \\
MLP           & 0.319 & 0.329 & 0.306 & 0.312 \\
\rowcolor{LightBlue} XGBoost       & 0.302 & 0.296 & 0.291 & 0.286 \\
Naive Bayes   & 0.259 & 0.260 & 0.250 & 0.254 \\
\rowcolor{LightBlue} Random Forest & 0.267 & 0.255 & 0.246 & 0.246 \\
Decision Tree & 0.207 & 0.210 & 0.218 & 0.211 \\
\rowcolor{LightBlue} AdaBoost      & 0.241 & 0.081 & 0.185 & 0.112 \\
\bottomrule
\end{tabular}
\caption{Held-out test set performance for all tuned models, sorted by F1-macro.\label{tab:testresults}}
\end{table}
...
\toprule
\textbf{Window (s)} & \textbf{No.\ Windows} & \textbf{5-Fold Mean} & \textbf{5-Fold Std} & \textbf{LOSO Mean} & \textbf{LOSO Std} \\
\midrule
\rowcolor{LightBlue} 0.2 & 1490 & 0.1497 & 0.0173 & 0.1550 & 0.0213 \\
0.4 & 1480 & 0.2581 & 0.0170 & 0.1831 & 0.0144 \\
\rowcolor{LightBlue} 0.6 &  980 & 0.3204 & 0.0373 & 0.1816 & 0.0095 \\
0.8 &  730 & 0.3123 & 0.0329 & 0.1644 & 0.0208 \\
\rowcolor{LightBlue} 1.0 &  580 & 0.3448 & 0.0397 & 0.1948 & 0.0541 \\
1.2 &  480 & 0.3125 & 0.0302 & 0.1625 & 0.0299 \\
\rowcolor{LightBlue} 1.4 &  410 & 0.3220 & 0.0605 & 0.1756 & 0.0701 \\
1.6 &  355 & 0.3944 & 0.0267 & 0.2141 & 0.0613 \\
\rowcolor{LightBlue} 1.8 &  315 & 0.3746 & 0.0162 & 0.1778 & 0.0324 \\
2.0 &  280 & 0.3857 & 0.0350 & 0.1750 & 0.0134 \\
\bottomrule
\end{tabular}
